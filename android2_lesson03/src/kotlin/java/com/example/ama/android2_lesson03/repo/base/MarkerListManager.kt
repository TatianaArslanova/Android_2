...
interface MarkerListManager {
    ...
    fun updateMarker(marker: SimpleMarker, newName: String,
                     callback: (markers: ArrayList<SimpleMarker>) -> Unit)
    ...
    fun prepareEditMarkerNameDialog(marker: SimpleMarker,
                                    callback: (dialogName: String, dialogMessage: String, editingMarker: SimpleMarker) -> Unit)
}